                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="diskon_total" class="form-control" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="ongkos_kirim" class="form-control" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="ppn" class="form-control" disabled>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#datatable').DataTable({
                ...
                info: false,
                ajax: {
                    url: '{{ route('pembelian.dataproduct') }}',
                    type: 'GET'
                },
                columns: [{
                        data: 'nama'
        ...
        function simpanProduct() {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route('pembelian.saveproduct') }}',
                dataType: 'html',
                headers: {
        ...
        function hitungTotal() {
            $.ajax({
                type: 'POST',
                url: '{{ route('pembelian.hitungtotal') }}',
                dataType: 'html',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
