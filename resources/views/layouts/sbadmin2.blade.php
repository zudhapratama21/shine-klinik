    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                <div class="sidebar-brand-text mx-1">Shine Beauty Care</div>
            </a>
                    ...
                    <div id="collapseTwo"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item {{ Route::is('dokter.index') ? 'active' : '' }}" href="/dokter">
                                Data Dokter</a>
                            <a class="collapse-item {{ Route::is('treatment.index') ? 'active' : '' }}"
                                href="/treatment">
                                Data Treatment</a>
                            <a class="collapse-item {{ Route::is('product.index') ? 'active' : '' }}" href="/product">
                                Data Produk</a>

                            <a class="collapse-item {{ Route::is('supplier.index') ? 'active' : '' }}"
                                href="/supplier">
                                Data Supplier</a>
                        </div>
                    </div>
            ...
            <!-- Nav Item - Utilities Collapse Menu -->            
                ...
                <li class="nav-item {{ Route::is('treatmentpasien.index') ? 'active' : '' }} ">
                    <a class="nav-link" href="/treatmentpasien">
                        <i class="fas fa-fw fa-cogs"></i>
                        <span>Data Treatment</span>
                    </a>
                </li>
                <li class="nav-item {{ Route::is('operasional.index') ? 'active' : '' }} ">
